...
st.title(':star2: DASHBOARD DE VENDAS :grin:')
...
dados = pd.DataFrame.from_dict(response.json()) #pega direto do json e transforma em dataframe
dados['Data da Compra'] = pd.to_datetime(dados['Data da Compra'], format = '%d/%m/%Y')

st.dataframe(dados) 

# Filtrando os dados de acordo com os Vendedores selecionados no multiselect, 
# usando a função 'isin' para filtrar os dados
...
## Tabelas
### Tabelas de receita
# nome da coluna = dados.groupby('coluna')['coluna'].função()
...
#Agrupando os dados por categoria do produto e somando o preço, depois ordenando pela receita
...
#gráfico de barras da receita por estado, mostrando apenas os 5 estados com maior receita
